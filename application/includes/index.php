...
echo "<table width=100% height=100% id='menu' cellspacing='0'><tr><td id='hmenu_title' colspan='2'>Project-RSA</td></tr><tr>";
echo "<th id='sitebar' height=100%>";
echo "<table width=300px cellspacing='0'>";
//edit
 echo "<tr style='background-color:#303030'><td><form method='post' action='Main.php'><table>";
 ...
 echo "<tr><td id='td_e'>Number </td><td><input name='city' style='width:95%' type='text' value='".$city."'/></td></tr>";
 ...
 //insert
 echo "<tr style='background-color:#303030'><td><form method='post' action='Main.php'><table width=100%>";
